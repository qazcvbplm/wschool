      ...
      <section id="main-content" >
          <section class="wrapper" >
              ...
              <div class="row" >
                  <div class="col-lg-12" >
                    <h1></h1>
                     <form action="addproduct.do" class="form-horizontal" enctype="multipart/form-data" method="post">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div onclick="image()" class="col-md-2 text-center">
                                   <img  width="100px" height="100px" alt="点击上传" >
                               </div>
                          </div>
                          <div class="form-group">
                              <label class="control-label col-md-1">商品售价</label>
                               <div class="col-md-2">
                              <input class="form-control" type="text" onkeyup="if( ! /^\d*(?:\.\d{0,2})?$/.test(this.value)){this.value='';}"  name="price"   required />
                              </div>
                          </div>
                           <div class="form-group">
